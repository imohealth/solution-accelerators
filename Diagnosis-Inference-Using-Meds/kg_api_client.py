...
Supports diagnosis inference via medication-linked narrower concepts.
"""
...
class KGApiClient:
    ...
    def get_medication_diagnosis_proto(
        ...
        Args:
            ...
            medication_codes: List of medication lexical codes (from normalize
                with domain="Medication").

        Returns:
            Dict with the base diagnosis title and its `domainNarrowerByMedications`
            list of {code, title, numberOfDomainChildren} entries.
        """
